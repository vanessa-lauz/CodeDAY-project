...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ONG aspa = new ONG(
                ...
                "Atuação voltada à proteção e ao cuidado de animais"
        );
        ...
        ONG apae = new ONG(
                ...
                "Atendimento e inclusão de pessoas com deficiência"
        );
        apae.addNecessidade("materiais de limpeza");
        apae.addNecessidade("roupas");

        ONG liga = new ONG(
                "Liga Feminina de Combate ao Câncer de Sant'Ana do Livramento",
                "Assistência a pessoas em situação de vulnerabilidade que enfrentam o câncer"
        );
        ...
        String textoVoluntario = JOptionPane.showInputDialog(
                null,
        ...
        try {
            ...
            if (ong == null) {
                ...
                JOptionPane.showMessageDialog(
                        null,
                        "Não encontramos uma ONG compatível."
                );
